...
import uppaal_model.backend.models.base.automaton as basic_automaton
...
# Template #
############
from uppaal_model.backend.models.ta.labels.assignment import Update, Reset
from uppaal_model.backend.models.ta.labels.guard import VariableGuard, ClockGuard
from uppaal_model.backend.models.ta.labels.invariant import Invariant
from uppaal_model.backend.models.ta.labels.parameter import Parameter
from uppaal_model.backend.models.ta.labels.select import Select
from uppaal_model.backend.models.ta.labels.sync import Synchronization


class Template(basic_automaton.Automaton):
    """An Uppaal model template class.
...
class Location(basic_automaton.Location):
    ...
    def assign_from(self, other, assign_ids=False, copy_view_data=True):
        ...
        self.testcode = copy.deepcopy(other.testcode)
