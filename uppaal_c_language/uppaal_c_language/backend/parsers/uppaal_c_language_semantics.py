...
# TODO: Add function enforcing precedence and associativity on input ASTs of arbitrary structure
#       Right now, only the combination of "ast_rotate_left_while_assoc_prec" and order enforced by the parser results
#       in correct result.
...
def split_logic_conjunction(ast):
    ...
    while (ast["astType"] == "BinaryExpr") and (ast["op"] == "LogAnd"):
